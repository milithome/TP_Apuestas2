...
def fechas_teams(id_team:int)->dict:
    ...
    if respuesta.status_code == 200:
        ...
        for fecha in range(len(fechas[0]['fixture'])):
            ...
            id_fechas[locales[fechas[0]['fixture']['teams']['home']['name']],visitantes[fechas[0]['fixture']['teams']['away']['name']]] = fechas[0]['fixture']['id']
    ...
    return fechas,locales,visitantes, id_fechas
